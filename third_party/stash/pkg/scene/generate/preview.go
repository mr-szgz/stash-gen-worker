...
import (
	...
	"github.com/mr-szgz/stash-gen-worker/third_party/stash/pkg/logger"
)
...
func (g *Generator) previewVideo(input string, videoDuration float64, options PreviewOptions, fallback bool, useVsync2 bool) generateFn {
	...
	return func(lockCtx *fsutil.LockContext, tmpFn string) error {
		...
		// Guard against durations that are too short to produce a video stream.
...
// PreviewWebp generates a webp file based on the generated preview video.
