...
import "github.com/mr-szgz/stash-gen-worker/third_party/stash/pkg/ffmpeg"
...
func Transcode(input string, options TranscodeOptions) ffmpeg.Args {
	...
	// Keep the existing slow-seek fallback local to transcode operations for parity with upstream behavior.
